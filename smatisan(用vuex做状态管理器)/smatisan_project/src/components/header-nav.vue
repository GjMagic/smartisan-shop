      ...
      <div class="nav-global">
        <div class="container">
          ...
          <ul class="nav-aside">
            ...
            <!--active-->
            <li class="nav-cart" :class="{active: getIsEnter}" @mouseenter="enterCartIcon" @mouseleave="leaveCartIcon">
...
export default {
  ...
  computed: {
    ...
    getIsEnter() {
      return this.$store.state.isEnter
    }
  },
  methods: {
    enterCartIcon() {
      this.$store.commit('enterCart')
    },
    leaveCartIcon() {
      this.$store.commit('leaveCart')
    }
  }
}
</script>
