<template>
  <div>
    ...
    <!--根据class改变颜色-->
    <span class="cart-empty-num" :class="{'cart-num': cartData.length}">
      <i>{{totalCount}}</i>
    </span>
      ...
      <div class="nav-cart-list">
        ...
        <div class="full" v-else>
          <div class="nav-cart-items">
            <ul>
              <li class="clear" v-for="(cartItem,index) in cartData" :key="index">
                <div class="cart-item js-cart-item cart-item-sell">
                  <div class="cart-item-inner">
                    ...
                    <div class="del-btn" @click="delSmallCart(cartItem)">删除</div>
                  </div>
                </div>
              </li>
            </ul>
          ...
          <div class="nav-cart-total">
            <p>共
              <strong class="ng-binding">{{totalCount}}</strong> 件商品</p>
            <h5>
              合计：
              <span class="price-icon">¥</span>
